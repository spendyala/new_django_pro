    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('electric_utility_rate', models.FloatField(default=0, verbose_name=b'Electric Utility Rate (per kWh)')),
                ...
                ('vfd_speed_control', models.CharField(default=0, max_length=256, verbose_name=b'VFD Speed Control', choices=[(1, b'YES'), (2, b'NO')])),
