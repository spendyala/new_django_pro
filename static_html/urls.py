...
urlpatterns = [
   ...
   url(r'^((?P<file_name>excel)/(?P<obj>(steam_leak|steam_trap|boiler_datacollection|stacked_economizer|valve_insulation|pipe_insulation))/(?P<rec_id>([0-9]+|all))|$)', views.index, name='index'),
