...
from vfd.serializers import LaborVFDMotorSerializer, MaterialsVFDMotorSerializer, VfdMotorSetpointSelectionsSerializer, VfdMotorDataPerMonthSerializer, VfdMotorSerializer
